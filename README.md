...
- [ ] Event WiFi / Cellular Data (Comms. for All Device Types))
- [ ] Bluetooth SPP (Comms. for Tablets)
- [ ] Ethernet (Comms. for Laptops)
- [ ] 6LoWPAN (Comms. between Multiple Pis at Event)
